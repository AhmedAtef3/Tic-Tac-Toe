...
class ChatHandler extends Thread {
    ...
    public void sendLoginDataAfterLoginSuccessfully(Player p)
    {
                    ...
                    ArrayList<Player> players = DbTask.getAll(p.getId());
                    sendSelfMessageWithFlag("login successfully", new Gson().toJson(players));
        ...
        while (true) {
            ...
            try {
                ...
                if (optionFlag.equals("chat")) {
                    ...
                    //second player
                    System.out.println("wtfffff"+str);
                    /*
                    rooms.add(new Room());
                    System.out.println("number of the rooms"+rooms.size());
                    rooms.get(roomNumber).setPlayer2(str);
...
//                    rooms.get(roomNumber).setPlayer1(str);
//                    roomNumber++;
...
//                    }
                ...
                try {
                    ...
                    System.out.println("why did you close me!!!");
    ...
    void sendMessageToPlayer(String username, String message) {
        for (ChatHandler ch : clientsArrayList) {
            if (ch.userName.equals(username)) {
                ...
                System.out.println("tag1:"+this.userName+ ", " + ch.userName);
    ...
    /*
    void sendCordinatesToPlayer(String[][] sentMessage) {
        for (ChatHandler ch : clientsArrayList) {
            System.out.println(sentMessage.getUsername() + ", " + sentMessage.getMessage() + ", " + ch.userName);
            if (ch.userName.equals(sentMessage.getUsername())) {
                ch.ps.println("text message");
